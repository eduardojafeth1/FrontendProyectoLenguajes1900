    ...
    <div class="container p-0">
        <div class="card m-0">
            ...
            <div class="card-body text-center p-5">
                <p class="fs-3 text-secondary">¿Está seguro que desea eliminar la habitacion "{{ $cliente['dni'] }}"?</p>
                <a href="{{ route('obtenerTodosHabitaciones') }}" class="btn btn-outline-primary me-2">Volver</a>
                <a href="{{ route('eliminarHabitacion', ['dni'=>$cliente['dni']]) }}" class="btn btn-primary">Sí, eliminar</a>
            </div>
        </div>
    </div>
@endsection
